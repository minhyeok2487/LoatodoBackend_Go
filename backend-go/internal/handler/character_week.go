...
func NewCharacterWeekHandler(ws *service.CharacterWeekService, cs *service.CharacterService) *CharacterWeekHandler {
	return &CharacterWeekHandler{weekService: ws, charService: cs}
}
