...
// DeleteCharacter handles DELETE /admin/api/v1/characters/{characterId}
func (h *AdminHandler) DeleteCharacter(w http.ResponseWriter, r *http.Request) {
	characterID := parseInt64Param(getPathParam(r, "characterId"))
	if err := h.svc.DeleteCharacter(r.Context(), characterID); err != nil {
		writeError(w, http.StatusBadRequest, err.Error())
		return
	}
...
// DeleteFriend handles DELETE /admin/api/v1/friends/{friendId}
func (h *AdminHandler) DeleteFriend(w http.ResponseWriter, r *http.Request) {
	friendID := parseInt64Param(getPathParam(r, "friendId"))
	if err := h.svc.DeleteFriendByAdmin(r.Context(), friendID); err != nil {
		writeError(w, http.StatusBadRequest, err.Error())
		return
	}
	writeJSON(w, http.StatusOK, map[string]string{"message": "friend deleted"})
}

// DeleteNotificationAdmin handles DELETE /admin/api/v1/notifications/{notificationId}
func (h *AdminHandler) DeleteNotificationAdmin(w http.ResponseWriter, r *http.Request) {
	notificationID := parseInt64Param(getPathParam(r, "notificationId"))
	if err := h.svc.DeleteNotificationByAdmin(r.Context(), notificationID); err != nil {
		writeError(w, http.StatusBadRequest, err.Error())
		return
	}
...
// GetContentDetail handles GET /admin/api/v1/contents/{contentId}
func (h *AdminHandler) GetContentDetail(w http.ResponseWriter, r *http.Request) {
	contentID := parseInt64Param(getPathParam(r, "contentId"))
	content, err := h.svc.GetContentDetail(r.Context(), contentID)
	if err != nil {
		writeError(w, http.StatusBadRequest, err.Error())
		return
	}
...
// CreateContent handles POST /admin/api/v1/contents
func (h *AdminHandler) CreateContent(w http.ResponseWriter, r *http.Request) {
	...
	result, err := h.svc.CreateContent(r.Context(), req)
	if err != nil {
		writeError(w, http.StatusBadRequest, err.Error())
		return
	}
...
// DeleteContent handles DELETE /admin/api/v1/contents/{contentId}
func (h *AdminHandler) DeleteContent(w http.ResponseWriter, r *http.Request) {
	contentID := parseInt64Param(getPathParam(r, "contentId"))
	if err := h.svc.DeleteContent(r.Context(), contentID); err != nil {
		writeError(w, http.StatusBadRequest, err.Error())
		return
	}
	writeJSON(w, http.StatusOK, map[string]string{"message": "content deleted"})
}
